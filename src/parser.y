...
var_decl	: type init_id_list MK_SEMICOLON 
            ...
            | ID id_list MK_SEMICOLON /* ID for typedef */
                {
                    /*TODO*/
                    $$ = makeDeclNode(VARIABLE_DECL);
            ...
            | IF MK_LPAREN relop_expr MK_RPAREN stmt
                {
                    ...
                    makeFamily($$, 3, $3, $5, Allocate(NUL_NODE)); /* Doubt */
                }
            /*TODO: | If then else */
...
relop_term	: relop_factor 
            ...
            | relop_term OP_AND relop_factor
                {
                    /*TODO*/
                    $$ = makeExprNode(UNARY_OPERATION, BINARY_OP_AND);
                    makeFamily($$, 2, $1, $3);
                }
            ;
            ...
            | OP_MINUS CONST
                {
                    ...
                    constantNode -> semantic_value.const1 = $2;
                    makeChild($$, constantNode);
                }
            | OP_NOT CONST
                {
                    /*TODO*/
            ...
            | OP_MINUS ID MK_LPAREN relop_expr_list MK_RPAREN
                {
                    ...
                    statementNode = makeFamily(statementNode, 2, makeIDNode($2, NORMAL_ID), $4);
                    makeChild($$, statementNode);
                }
